    ...
    return (
      <div className="page">
        <div className="section-hero">
          ...
          <h1 className="page-title hero-title">Start your {meta.label} collection</h1>
          <p className="page-sub hero-sub">
            {section === "sports"
              ? "Rookies, refractors, vintage — every copy gets its own grading history, media package and PSA submission decision."
              : "Every copy gets its own grading history, media package and PSA submission decision."}
          </p>
          <div className="hero-actions">
            <Link href={`/${section}/collection/new`} className="btn primary">Add your first card</Link>
            <Link href={`/${section}/collection`} className="btn">Open collection</Link>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="page">
      <div className="page-head">
        <div><h1 className="page-title">{meta.label} dashboard</h1><p className="page-sub">Inventory, grading queue, media and PSA submission decisions in one place.</p></div>
        <Link href={`/${section}/grading`} className="btn primary">Open grading queue</Link>
      </div>
      ...
      <div className="section-grid">
        <div>
          <div className="card-head" style={{ border: 0, paddingLeft: 0 }}><div className="card-title">Highest raw-value cards</div><Link href={`/${section}/collection`} className="btn">View collection</Link></div>
